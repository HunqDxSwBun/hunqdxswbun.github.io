...
function chuyenDoi() {
  ...
  var inputTypeYTB = document.getElementById("inputTypeYTB").value;
  ...
  iframe.src = "https://convert2mp3s.com/api/" + encodeURIComponent(downloadType) + "/" + encodeURIComponent(inputTypeYTB) + "?url=" + encodeURIComponent(inputText);
